...
- Local file: `/mnt/c/Users/minou/juken-bancho/web/assets/audio/flesh-and-blood.mp3`
- License: CC0
...
| Ending | Title | Author | Source | Local file |
| --- | --- | --- | --- | --- |
| `合格番長` | `Victory` | celestialghost8 | `https://opengameart.org/content/victory` | `/mnt/c/Users/minou/juken-bancho/web/assets/audio/endings/passed-bancho-victory.mp3` |
| `孤独な合格` | `Sad Theme` | Polilla | `https://opengameart.org/content/sad-theme` | `/mnt/c/Users/minou/juken-bancho/web/assets/audio/endings/lonely-pass-sad-theme.mp3` |
| `補欠の伝説` | `Forgotten Victory` | yd | `https://opengameart.org/content/forgotten-victory` | `/mnt/c/Users/minou/juken-bancho/web/assets/audio/endings/waitlist-forgotten-victory.ogg` |
| `番長伝説` | `Determination` | artisticdude | `https://opengameart.org/content/determination` | `/mnt/c/Users/minou/juken-bancho/web/assets/audio/endings/bancho-legend-determination.mp3` |
| `不合格` | `Game Over` | Kistol | `https://opengameart.org/content/game-over` | `/mnt/c/Users/minou/juken-bancho/web/assets/audio/endings/failed-game-over.ogg` |
...
| Ending | Generated source | Local file |
| --- | --- | --- |
| `合格番長` | `/home/minougun/.codex-wsl/generated_images/019dc099-3099-7753-9c28-0b7765b5c4f6/ig_044ff7593fe574a60169ebc159a6548191aecb90815205028a.png` | `/mnt/c/Users/minou/juken-bancho/web/assets/images/endings/passed-bancho.png` |
| `孤独な合格` | `/home/minougun/.codex-wsl/generated_images/019dc099-3099-7753-9c28-0b7765b5c4f6/ig_044ff7593fe574a60169ebc18b9aac8191b39f8e25820ff3a9.png` | `/mnt/c/Users/minou/juken-bancho/web/assets/images/endings/lonely-pass.png` |
...
- OtoLogic `力がみなぎる`
- Source: `https://otologic.jp/free/bgm/rock01.html`
- License note: OtoLogic materials are provided under CC BY 4.0 with credit required.
- Reason not embedded: the official ZIP download returned 403 from this environment, so it was not added to the local test build.
