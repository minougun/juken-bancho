...
Created: 2026-05-14 20:40 JST

Purpose: do not approve the cast by parameter table alone. Start VOICEVOX Engine, play the fixed lines below, and judge whether the character can be identified without looking at the screen.
...
| narrator | `1年春、入学式。三年間の予定表が開いた。` | `第2章、模試の空気が変わった。` | Minimal information voice; do not use for protagonist monologue. |
...
- Too high / too low:
- BGM balance:
- Identifiable speaker score 1-5:
- Natural character score 1-5:
- Operation tempo score 1-5:
- Keep / adjust:

Known gaps until this is run:

- VOICEVOX Engine has not been started in the current verification.
- Browser/OS fallback does not prove final character acting quality.
- Mobile SpeechSynthesis behavior needs iOS Safari and Android Chrome checks.
