    ...
    intro: [
      {
        speaker: "受験番長",
        sceneTag: "1年春・入学式",
        text: "願書の下書きを握ったまま、舎弟の徹平からの通知を開いた。文面が、いつもの三倍震えていた。\n徹平「番長、数学9点っす。進路希望票、親に見せたら終わるっす」\n机に座れば徹平を見捨てる。徹平へ走れば、願書は白紙のままだ。",
      },
      {
        speaker: "受験番長",
        sceneTag: "新しい教室",
      ...
      },
      {
        speaker: "受験番長",
        sceneTag: "三年計画",
        text: "学力だけじゃ受からねえ。人望だけでも届かねえ。\n三年間、机・仲間・メンツ・体力のどれを削るか選べ。",
        voiceText:
          "学力だけじゃ受からねえ。人望だけでも届かねえ。三年間、机、仲間、メンツ、体力のどれを削るか選べ。",
      },
    ],
  },
  {
    ...
    intro: [
      ...
      },
      {
        speaker: "優等生ギャル",
        sceneTag: "三年計画",
        text: "学力だけじゃ受からない。友情だけでも届かない。\n三年間、机・仲間・メンツ・体力のどれを削るか選ぶ。",
        voiceText:
          "学力だけじゃ受からない。友情だけでも届かない。三年間、机、仲間、メンツ、体力のどれを削るか選ぶ。",
      },
    ],
  },
];
